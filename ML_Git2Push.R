...
results <- rfe(dat[,2:3565], dat[,1], sizes=c(1:3565), rfeControl=control) # column 1 target var
...
varimp_RFE <- data.frame(feature = row.names(varImp(results))[1:726],importance = varImp(results)[1:726, 1])
